    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center shrink-0">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">Gestiona bajas, listas negras y registros de auditoría.</p>
        </div>
        <Button variant="outline"><FileText className="mr-2 h-3.5 w-3.5" /> Exportar Registro RGPD</Button>
      </div>
          ...
          <Card>
            <CardHeader className="pb-3 border-b border-slate-100">
              <CardTitle className="text-lg flex items-center">
                <ShieldAlert className="mr-2 h-5 w-5 text-red-500" /> Lista de Exclusión (Blocklist)
              </CardTitle>
            </CardHeader>
            <div className="p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50">
              <div className="relative w-64">
                <Search className="absolute left-2.5 top-2.5 h-4 w-4 text-slate-500" />
                <Input placeholder="Buscar correos o dominios..." className="pl-9 bg-white" />
              </div>
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell><Badge variant="secondary">Correo</Badge></TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell><Badge variant="outline">Dominio</Badge></TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell><Badge variant="outline">Patrón</Badge></TableCell>
